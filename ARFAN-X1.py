...
#---------------------------> logo ------------------------->>>>>
JAVAet = f'''
{A1}       db       88""Yb 888888  db     88b    88
{A1}    dPYb     88__dP88__    dPYb   88 Yb 88
{A1}  dP__Yb   88"Yb   88""   dP__Yb  88  Y  88 
{A1}dP" " " "Yb88   Yb  88   dP" " " "Yb88   Y88
{A1}[~] DEVOLOPER  :  ARFAN X RIDOY
{A2}[~] TOOLS      :  FREE		 WHATSUP: 01997745734
'''
#----------------------------> clear -------------------------->>>>>
...
#----------------------------> string -------------------------->>>>>
def __rand__():
    clear();print(f"{A1}[~] EXAMPLE : 01710 01609 01819 019 ")
